...
Function updatedl()
	On Error Resume Next
	textf ""
	textf "  Current version: " & currentVersionST
	oWEB.Open "GET", "https://raw.githubusercontent.com/ivandfx/DFXWinTweaks/main/update", False
	oWEB.Send
	textf "  Newest version: " & oWEB.responseText
	...
	If CDbl(Replace(oWEB.responseText, vbcrlf, "")) > CDbl(currentVersion) Then
		...
		If res = "y" Then
			textf ""
			textl "  Downloading... "
			oWEB.Open "GET", "https://raw.githubusercontent.com/ivandfx/DFXWinTweak/main/dfxwt_latest.vbs", False
			oWEB.Send
			wait 1
		...
		End If
	Else
		textf "  You have the latest version"
		textf "  Starting DFX WinTweaks..."
	End If
End Function
